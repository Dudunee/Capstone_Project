"""
Django settings for moviereview_api project.
...
SECRET_KEY = "django-insecure-vonajl4wa47pq=m(t4bj5v=hijm_ku#@kecz88pu7n!=p)q!$q"
...
WSGI_APPLICATION = "moviereview_api.wsgi.application"
